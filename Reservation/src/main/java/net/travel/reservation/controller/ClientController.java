...
public class ClientController {
    ...
    // Ajouter un client (Validation activée avec @Valid)
    @PostMapping
    ...
    // Modifier un client (Validation activée avec @Valid)
    @PutMapping("/{id}")
    ...
    // Recherche par CIN
    @GetMapping("/cin/{cin}")
    public ResponseEntity<Client> getByCin(@PathVariable String cin) {
    ...
    public ResponseEntity<List<Client>> getByVille(@PathVariable String ville) {
        return ResponseEntity.ok(clientService.getByVille(ville));
    }
}